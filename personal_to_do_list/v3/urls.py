...
urlpatterns = [
    ...
    path('delete-to-do-list/<int:list_id>', personal_to_do_list_view.DeleteToDoListView.as_view(), name='delete-to-do-list-v3'),
    ...
    path('create-uuid/<int:task_id>/<int:list_id>', personal_to_do_list_view.CreateUUIDView.as_view(), name='create'
                                                                                                            '-uuid-v3'),
    path('delete-task/<int:task_id>/<int:list_id>', personal_to_do_list_view.DeleteTaskView.as_view(), name='delete-task-v3'),
]

...
urlpatterns = [
    ...
    path('create-task-with-uuid/<int:list_id>', personalToDoListView.TasksPageView.as_view(), name='create-task-with-uuid-v2'),
    ...
    path('create-uuid/<int:task_id>', personalToDoListView.HandleTaskView.as_view(), name='create-uuid-v2'),
]
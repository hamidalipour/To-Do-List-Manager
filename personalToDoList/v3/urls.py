...
urlpatterns = [
    ...
    path('handle-task/<int:task_id>', personalToDoListView.HandleTaskView.as_view(), name='handle-task-v3'),
    path('create-uuid/<int:task_id>', personalToDoListView.CreateUUIDView.as_view(), name='create-uuid-v3'),
]